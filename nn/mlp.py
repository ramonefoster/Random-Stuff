...
class RandomForest():
    ...
    def train():
        ...
        rna = MLPRegressor(activation='tanh', alpha=0.01, hidden_layer_sizes=(10,3),
...
RandomForest.make_predict(hms_to_hours("04:16:12.00"), dec=dms_to_degrees("-8 45 56"), temp=18, 
                          latitude=dms_to_degrees("-22 32 04"), prev_ha=hms_to_hours("02:21:46.67"), prev_dec=dms_to_degrees("+09 53 32"))


# 04:16:12.00 -08:49:05.63
# 04:17:14.00 -08:52:33.82